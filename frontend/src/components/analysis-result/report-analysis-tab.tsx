  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-4">
            <p className="text-sm text-muted-foreground">
              Upload your medical reports, X-rays, or doctor prescriptions for a
              more personalized analysis. Supported file types: PDF, JPG, PNG.
            </p>
            ...
            <div className="border-2 border-dashed rounded-lg p-6 text-center">
              ...
              <p className="text-xs text-muted-foreground mb-4">
                Max 10MB per file • Up to 10 files • PDF, JPG, PNG formats
                recommended
              </p>
              <Button
                variant="outline"
              ...
              <Alert variant="destructive">
                ...
                <div className="mt-2 text-xs">
                  {errorMessage.includes("Failed to analyze") && (
                    <span>
                      Try uploading a different file format (PDF recommended) or
        ...
        <div className="space-y-6">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="w-full bg-muted mt-2 h-2 rounded-full overflow-hidden">
                      <div
                        ...
                        style={{
                          width: `${(reportInsights.healthScore / 10) * 100}%`,
                        }}
                      />
                    </div>
                  </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              {reportInsights.keyFindings.map(
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                {reportInsights.possibleConditions.map(
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <Card>
              ...
              <CardContent>
                <ul className="space-y-2">
                  {reportInsights.followUpActions.map(
            ...
            <Card>
              ...
              <CardContent>
                <ul className="space-y-2">
                  {reportInsights.riskFactors.map(
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <ul className="space-y-1">
                    {reportInsights.mealRecommendations.breakfast.map(
                ...
                <div>
                  ...
                  <ul className="space-y-1">
                    {reportInsights.mealRecommendations.lunch.map(
                      (item: string, i: number) => (
                        <li key={i} className="text-sm flex items-start gap-2">
                          <span className="text-primary">•</span>
                          <span className="text-muted-foreground">{item}</span>
                ...
                <div>
                  ...
                  <ul className="space-y-1">
                    {reportInsights.mealRecommendations.dinner.map(
                      (item: string, i: number) => (
                        <li key={i} className="text-sm flex items-start gap-2">
                          <span className="text-primary">•</span>
                          <span className="text-muted-foreground">{item}</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <Card>
              ...
              <CardContent>
                <ul className="space-y-2">
                  {reportInsights.exercisePlan.map(
            ...
            <Card>
              ...
              <CardContent>
                <ul className="space-y-2">
                  {reportInsights.preventiveMeasures.map(
              ...
              <Card>
                ...
                <CardContent>
                  <Accordion type="single" collapsible className="space-y-2">
                    {reportInsights.ayurvedicMedication.recommendations.map(
      ...
      <div className="text-sm text-muted-foreground bg-muted/20 p-4 rounded-lg">
        <p className="text-xs">
          <strong>Privacy Note:</strong> Your medical reports are processed
          securely and are not stored permanently on our servers. All data is
